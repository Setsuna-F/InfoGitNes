...
class ContributorsController extends Controller
{
    ...
    */
    public function acontributorAction($name)
    {
        ...
        $this->parse_json->getBranchesByContributor('Francesco Tassi');
        ...
        return $this->render('IGNInfoGitBundle:Contributors:acontributor.html.twig', array('infoContributor' => $this->parse_json, 'infoBranches' => $this->parse_json_commit, 'name'=>$name));
    }
    ...
    */
    public function allcontributorsAction()
    {
        ...
        return $this->render('IGNInfoGitBundle:Contributors:allcontributors.html.twig', array('infoContributor' => $this->parse_json));
    }
}
