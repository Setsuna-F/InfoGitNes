...
module NamesManager
  ...
  map "Annabel Dunstone Gray", "Annabel Dunstone"
  map "Taurie Davis",          "tauriedavis"
  map "Zeger-Jan van de Weg",  "Z.J. van de Weg", "ZJ van de Weg"
  map "Winnie",                "winniehell"
  map "Rubén Dávila",          "Rubén Dávila Santos"
  map 'Luke "Jared" Bennett',  "Luke Bennett"
